...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2._request('POST', 'https://sts.miicard.com/api/v1/Claims.svc/json/GetClaims', 
    ...
    try {
      ...
      profile.id = json.Data['Username'];
      profile.displayName = json.Data['FirstName'] + " " + json.Data["LastName"];
